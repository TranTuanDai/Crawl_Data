...
df_chidinh = pd.read_excel('/FRT/16.Side_Effect/Get_text/Book3_test.xlsx')
df_disease = pd.read_excel('/FRT/16.Side_Effect/Get_text/MDM.xlsx')
...
df_chidinh.drop_duplicates().to_excel('D:/FRT/5.Python/Template_boc_text/ketqua_vs_v4.xlsx', index=False)